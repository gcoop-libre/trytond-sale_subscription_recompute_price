#!/usr/bin/env python3
# This file is part of the sale_subscription_recompute_price module for Tryton.
...
url = 'https://github.com/gcoop-libre/%s' % MODULE
download_url = 'https://github.com/gcoop-libre/%s/tree/%s.%s' % (
...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://gcoop.coop',
    download_url=download_url,
    project_urls={
        "Bug Tracker": 'https://github.com/gcoop-libre/%s/issues' % MODULE,
        "Documentation": 'https://docs.tryton.org/',
        "Forum": 'https://www.tryton.org/forum',
        "Source Code": url,
        },
    keywords='sale subscription recompute price',
